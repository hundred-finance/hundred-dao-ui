export const pickleGaugeControllerABI = [
  { inputs: [], stateMutability: 'nonpayable', type: 'constructor' },
  { inputs: [], name: 'DILL', outputs: [{ internalType: 'contract IERC20', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
  { inputs: [], name: 'MASTER', outputs: [{ internalType: 'contract MasterChef', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
  { inputs: [], name: 'PICKLE', outputs: [{ internalType: 'contract IERC20', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
  { inputs: [], name: 'TOKEN', outputs: [{ internalType: 'contract IERC20', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
  { inputs: [], name: 'acceptGovernance', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  { inputs: [{ internalType: 'address', name: '_token', type: 'address' }], name: 'addGauge', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  ...
  { inputs: [], name: 'pendingGovernance', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
  { inputs: [], name: 'pid', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
  { inputs: [{ internalType: 'address', name: '_owner', type: 'address' }], name: 'poke', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  ...
  { inputs: [{ internalType: 'uint256', name: '_pid', type: 'uint256' }], name: 'setPID', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
  ...
  {
    inputs: [
      { internalType: 'address[]', name: '_tokenVote', type: 'address[]' },
