      ...
      <div className={ theme.palette.type === 'dark' ? classes.containerDark : classes.container }>
        <div className={ classes.copyContainer }>
          <div className={ classes.copyCentered }>
            <Typography variant='h1' className={ classes.chainListSpacing }><span className={ classes.helpingUnderline }>SharedTools</span></Typography>
            ...
            <Typography className={classes.subTitle}><a href='https://factory.sharedtools.org' target='_blank'>Access contract factories here.</a></Typography>
          </div>
          <div className={ classes.socials }>
            <a className={ `${classes.socialButton}` } href='https://github.com/chimera-defi/sharedtools-index' target='_blank' rel="noopener noreferrer" >
