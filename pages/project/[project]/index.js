...
function isLZMirroringAvailable(project) {
  return (
    ((project?.layerZero !== undefined || project?.multichain !== undefined) && project?.targetChainMirrorGates?.length !== 0) ||
    (project?.mirrored_locks && project?.mirrored_locks.length > 0)
  );
}
